...
```bash
cd embla/.Codex/plugins/embla-tools
...
- `@anthropic-ai/Codex-agent-sdk` - Codex Agent SDK for MCP servers
...
### System Prompt Modes
- **Replace**: Completely replaces Codex prompt (most common)
- **Append**: Adds constraints to base Codex prompt
